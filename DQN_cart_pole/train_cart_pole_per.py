'''
Priorities Experience Replay
- model : DQN, DDQN, Dueling DQN
- replay : PER(Priorities Experience Replay)
- weights : batch samples weights from PER
'''
...
parser = argparse.ArgumentParser(description="training cart pole with PER")
...
plt.savefig("./results/DDQN_with_PER_loss_reward_curve.png")