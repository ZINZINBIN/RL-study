...
parser = argparse.ArgumentParser(description="training atari with Rainbow DQN")
...
parser.add_argument("--wandb_save_name", type = str, default = "RainbowDQN-exp001")
...
# Network loaded
policy_net = RainbowDQN(screen_height, screen_width, n_actions, num_atoms, V_min, V_max, hidden_dims)
target_net = RainbowDQN(screen_height, screen_width, n_actions, num_atoms, V_min, V_max, hidden_dims)
