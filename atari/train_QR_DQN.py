...
import random
import math
from src.train import optimize_QR_DQN, optimize_categorical_DQN
import wandb
import gc
...
parser = argparse.ArgumentParser(description="training atari with QR-DQN")
...
parser.add_argument("--wandb_save_name", type = str, default = "QRDQN-exp001")
...
parser.add_argument("--num_quant", type = int, default = 51)
